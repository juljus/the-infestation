...
[CreateAssetMenu(fileName = "Attack", menuName = "Enemy/Attack/Boss1")]
public class Boss1Attack : EnemyAttackBase
{
    [Header("Boss 1 Extra Stats")]
    // general
    ...
    {
        var clone = ScriptableObject.CreateInstance<Boss1Attack>();
